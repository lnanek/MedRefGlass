...
public class NoSearchMatchesCard {

	private static final Logger LOG = Logger.getLogger(NoSearchMatchesCard.class
			.getSimpleName());
	...
	public static boolean insert(HttpServletRequest request, Credential credential) {
		...
		timelineItem.setSourceItemId("medref-results-nomatches");
		timelineItem.setText("No matches found");
		timelineItem.setSpeakableText("No matches found");
